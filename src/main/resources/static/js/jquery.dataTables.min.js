...
(function (h) {
    ...
    function qb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<form class="sidebar-search-box my-2 px-4"><div class="mt-1 form-group"><input type="search" class="form-control"' + b.sFilterInput + '><label class="form-label"for="inputsearch"></label> <i class="form-input__icon svg-icon fas fa-search"></i> <spanclass="form-line--anime"></span></div></form>',
            j = d.sSearch,
